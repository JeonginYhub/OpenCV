...
from tensorflow.keras.optimizers import SGD #스토캐스틱 경사 하강법 - SGD
...
mlp.compile(loss='MSE', optimizer=SGD(learning_rate=0.01), metrics=['accuracy']) #손실 함수: MSE, 옵티마이저: SGD(학습률 0.01), 평가 지표: 정확률 (accuracy)
